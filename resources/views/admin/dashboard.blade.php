...
<body>
    ...
    <div class="container mt-5">
        <div class="mb-4">
            ...
            <p class="text-muted">Ringkasan performa dan informasi stok terbaru.</p>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-md-3">
                <a href="{{ route('admin.users') }}" class="btn btn-primary w-100">Manage Users</a>
            </div>
            <div class="col-md-3">
                <a href="{{ route('admin.products') }}" class="btn btn-success w-100">Manage Products</a>
            </div>
            <div class="col-md-3">
                <a href="{{ route('admin.orders') }}" class="btn btn-info w-100">History Orders</a>
            </div>
        </div>
    </div>
